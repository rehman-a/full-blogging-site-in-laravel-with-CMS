...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="title" content="Blog Haven  ">
    <meta name="description" content="Blog Haven is the ideal online location for both writers and readers. ">
    <meta name="keywords" content="food blogs, music blogs, trending blogs in world,">
    <meta name="author" content="Rehman Ali">
    ...
    <div class="container mx-auto flex flex-wrap py-6">
        ...
        <section class=" md:w-2/3 flex flex-col items-center px-3">
            ...
            <article class="flex flex-col shadow my-4">
                ...
                @else
                    <img src="<?php echo $post -> image; ?>" width="1000" height="500" alt="{{ $post_title->title }}">
                @endif
